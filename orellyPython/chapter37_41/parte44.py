...
# Interact, setup
for c in 'Congratulations Python Dev!'.upper():
    #Imprime/almacena un caracter en el buffer, que sera retenido por sys.stdout.flush().
    print(c, end=' ')
    
    #Permite vaciar el buffer para enviarlo a la terminal.
    sys.stdout.flush()    # Else some shells wait for \n
    #Permite manipular el tiempo en que va saliendo la informacion de c en el terminal.
    time.sleep(0.1)
...
file = open('orellyPython/chapter37_41/'+saveto, 'w') 
...
file = open('orellyPython/chapter37_41/'+htmlto, 'w')
